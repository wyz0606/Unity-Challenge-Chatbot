...
namespace IBM.Watson.Examples
{
    public class ExampleAssistantV1 : MonoBehaviour
    {
        ...
        private IEnumerator CreateService()
        {
            ...
            IamAuthenticator authenticator = new IamAuthenticator(apikey: "rWpvDE62dFe17gE4_dXjIkH5OwmhP1Mk8BKM-HqijD5f");

            //  Wait for tokendata
            while (!authenticator.CanAuthenticate())
                yield return null;

            service = new AssistantService("2019-04-17", authenticator);
            service.SetServiceUrl("https://api.us-south.assistant.watson.cloud.ibm.com/instances/128ee852-e7fc-436d-90b3-d800b01afa74");
